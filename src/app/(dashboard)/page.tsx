        ...
        <Card className="rounded-none border-border/50 bg-card/50 premium-card">
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-muted-foreground mt-1 flex items-center gap-1">
              <span className="text-primary font-bold">+0.07</span> from last assessment
            </p>
          </CardContent>
        </Card>
        <Card className="rounded-none border-border/50 bg-card/50 premium-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{currentUser.attendance}%</div>
            <p className="text-[10px] text-muted-foreground mt-1">
              92/98 sessions completed
            </p>
          </CardContent>
        </Card>
        <Card className="rounded-none border-border/50 bg-card/50 premium-card">
